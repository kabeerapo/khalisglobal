...
//#region node_modules/.nitro/vite/services/ssr/assets/router-jve8wDOc.js
var router_jve8wDOc_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-CrEhVbIF.css";
var APP_NAME = "Khalis Typing Center";
var publicHost = String("").trim().replace(/^https?:\/\//, "");
var xBanner = publicHost ? `https://${publicHost}/x-banner.jpg` : void 0;
var FAMILY_VISA_SCHEMA = {
	"@context": "https://schema.org",
	"@type": "VideoObject",
	name: "Khalis Typing Center — Family Visa Services in the UAE",
	description: "Bring your family to the UAE or renew their visas: birth and marriage certificate attestation, new visa applications, visa renewal, outside entry permit, 60/90-day self-sponsored visit visas, Family Golden Visa, and visa holding while you travel.",
	thumbnailUrl: "/poster-family.webp",
	uploadDate: "2026-08-26",
	duration: "PT59S",
	contentUrl: "/khalis-family-visa.mp4",
	embedUrl: "/#family-visa",
	transcript: "Looking to bring your family to the UAE or renew their visas without any stress? At Khalis Typing we provide complete family visa service with professional guidance and fast processing. Birth certificate attestation, marriage certificate attestation, new visa applications, visa renewal, outside entry permit, self-sponsored visit visas for 60 or 90 days, Family Golden Visa, and visa holding while you are away. Contact 050 120 1818 or info@khalisglobal.com."
};
var VIDEO_SCHEMA = {
	"@context": "https://schema.org",
	"@type": "VideoObject",
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Khalis Typing Center in Abu Dhabi — PRO services, typing, business setup, visa processing, document attestation and professional licensing."
			},
			{
				name: "theme-color",
				content: "#00665c"
	...
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			className: "bg-mist text-ink antialiased",
			children: [
...
var $$splitComponentImporter = () => import("./routes-BIIfEBfJ.mjs");
...
//#endregion
export { getRouter, router_jve8wDOc_exports as t };
